...
//            if(status.equals(Status.ACCEPTING) && !bookingRepo.checkLich(id, bookingDTO.getIdHour(),
//                    bookingDTO.getIdUser(),Status.ACCEPTING,ConvertTimeUtils.stringToDate(bookingDTO.getDate())).isEmpty()){
//                throw new ResourceAlreadyExitsException("Lich da bi trung voi lich trong thoi khoa bieu");
//            }
